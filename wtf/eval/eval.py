...
This script implements the evaluation of trained agents in the Hockey environment.
It includes functions to simulate matches, compute win rates, and generate visualizations of the results.
'''
...
import wtf.eval.plotting as plo
