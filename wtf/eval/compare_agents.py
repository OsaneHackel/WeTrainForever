'''
Initial version of theis script is AI generated but used own gif creation and eval script as foundation. 
This script compares the performance of different agents (SAC, TD3, basic opponents) in the Hockey environment.
It evaluates win rates, generates GIFs of matchups, and creates visualizations of the results
'''
