...
This script implements the training loop for a Soft Actor-Critic (SAC) agent in the Hockey environment. 
The agent learns to play against two types of opponents: a weak opponent and a strong
'''
import random
import numpy as np
import torch
...
from wtf.utils import create_state_dict
...
if __name__ == "__main__":
    ...
    agent = SAC(
        ...
        lr=6e-4,
        #policy = "Flow",    if flow: comment out evaluate in train_sac_step_based
